...
weights_name = "hcvitnet"
weights_path = "/mnt/nvme1n1p1/ldd/2d_seg/log/log_isic2017/{}".format(weights_name)
test_weights_name = weights_name
log_name = "/mnt/nvme1n1p1/ldd/2d_seg/log/log_isic2017/{}".format(weights_name)
monitor = 'val_mIoU'
monitor_mode = 'max'
save_top_k = 1
save_last = False
